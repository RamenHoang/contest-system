...
export const FormPublish = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(`http://localhost:3000/competition/cuoc-thi/intro/${id}/${slug}`);
  ...
  return (
    <div className='-mt-10'>
      <div className='mb-4'>
        ...
        <Input
          size='large'
          value={`http://localhost:3000/competition/cuoc-thi/intro/${id}/${slug}`}
          readOnly
          addonAfter={
      ...
      <div>
        ...
        <QRCode value={`http://localhost:3000/competition/cuoc-thi/intro/${id}/${slug}` || '-'} size={250} />
      </div>
